/* dprt_test.c
** $Header: /home/cjm/cvs/libdprt-scs/test/dprt_test.c,v 1.1 2005-03-11 11:57:24 cjm Exp $
*/
/**
 * dprt_test.c Tests libdprt_scs, the Data Pipeline Real Time
 ...
 */
static char rcsid[] = "$Id: dprt_test.c,v 1.1 2005-03-11 11:57:24 cjm Exp $";
/**
...
static void Help(void)
{
	fprintf(stdout,"dprt_test Tests the reduction routines in libdprt_scs.\n");
